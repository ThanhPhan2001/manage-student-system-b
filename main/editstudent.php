...
?>
                        ...
                        <form action="saveeditstudent.php" method="post" enctype="multipart/form-data">
                            <center>
                                <h4><i class="icon-edit icon-large"></i> Edit Student</h4>
                            </center>
                            <hr>
                            <div id="ac">
                                <input type="hidden" name="memi" value="<?php echo $id; ?>" />
                                <span>Reg No. : </span><input type="text" style="width:265px; height:30px;"
                                    name="student_id" value="<?php echo $row['student_id']; ?>" readonly Required /><br>
